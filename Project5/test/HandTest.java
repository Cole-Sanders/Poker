...
public class HandTest {
    ...
    public void testIsStraight() {
        Card[] cards = {new Card(8,'s'), new Card(3,'h'), new Card(4,'c'), new Card(5,'h'), 
                        new Card(6,'d')};
    ...
    public void testIsStraightFlush() {
        Card[] cards = {new Card(2,'s'), new Card(5,'s'), new Card(4,'s'), new Card(3,'s'), 
                        new Card(6,'s')};
    ...
    public void testIsRoyalFlush() {
        Card[] cards = {new Card(14,'d'), new Card(11,'d'), new Card(12,'d'), new Card(13,'d'), 
                        new Card(10,'d')};
    ...
    public void testHasFourOfAKind() {
        Card[] cards = {new Card(5,'c'), new Card(5,'s'), new Card(5,'d'), new Card(5,'s'), 
                        new Card(4,'s')};
    ...
    public void testHasThreeOfAKind() {
        Card[] cards = {new Card(3,'c'), new Card(5,'s'), new Card(5,'d'), new Card(5,'s'), 
                        new Card(4,'s')};
    ...
    public void testHasTwoPairs() {
        Card[] cards = {new Card(3,'c'), new Card(9,'s'), new Card(5,'d'), new Card(5,'s'), 
                        new Card(3,'s')};
    ...
    public void testHasOnePair() {
        Card[] cards = {new Card(3,'c'), new Card(9,'s'), new Card(7,'d'), new Card(5,'s'), 
                        new Card(3,'s')};
        Hand onePair = new Hand(cards);
        assertTrue(onePair.hasOnePair(), "One pair hand");
